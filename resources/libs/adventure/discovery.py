...
def LINKDISC(name,url):
        ...
        if Full:
            ...
            # play with bookmark           
            player = playbackengine.PlayWithoutQueueSupport(final, 'plugin.video.mafiaTV', video_type='', title=name,season='', episode='', year='', watch_percent=0.85, watchedCallbackwithParams=main.WatchedCallback, img=thumbList[0], infolabels={'Title':name,'Plot': plotList[0]})
