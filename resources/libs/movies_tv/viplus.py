...
art = main.art
smalllogo = xbmc.translatePath('special://home/addons/plugin.video.mafiaTV/resources/art/smallicon.png')
...
def VIP(murl):
        ...
        if debriduser == '' and debridpass == '':
                ...
                dialog.ok("[COLOR=FF67cc33]mafiatv[/COLOR]", "Please set your VIP++ credentials", "in Addon settings under logins tab")
