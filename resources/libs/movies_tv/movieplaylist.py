...
Mainlogo = xbmc.translatePath('special://home/addons/plugin.video.mafiaTV/icon.png')
refererTXT = xbmc.translatePath('special://home/addons/plugin.video.mafiaTV/resources/message/referer.txt')    
...
def resolve_videto(url,referer):
    ...
    try:
        ...
        addon.log_error('MafiaTV: Resolve Vidto - Requesting GET URL: '+url)
        r = re.findall(r'<font class="err">File was removed</font>',html,re.I)
        if r:
            addon.log_error('MafiaTV: Resolve Vidto - File Was Removed')
        ...
        print 'MafiaTV: Resolve Vidto Error - '+str(e)
        addon.show_small_popup('[B][COLOR green]MafiaTV: Vidto Resolver[/COLOR][/B]','Error, Check XBMC.log for Details',
                               5000, elogo)
...
def resolve_mightyupload(url,referer):
    ...
    try:
        ...
        addon.log_error('MafiaTV: Resolve MightyUpload - Requesting GET URL: '+url)
        ...
        print 'MafiaTV: Resolve MightyUpload Error - '+str(e)
        addon.show_small_popup('[B][COLOR green]MafiaTV: MightyUpload Resolver[/COLOR][/B]','Error, Check XBMC.log for Details',
                               5000, elogo)
        return
...
def MLink2(mname,murl,thumb,muvideo=False):
        ...
        if not muvideo:
                ...
                listitem.setInfo("Video", {"Title":mname,"Plot":'mafiatv Launch Video',"Genre":'mafiatv Video'})
