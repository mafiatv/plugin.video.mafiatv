...
if user == '' or passw == '':
    ...
    ret = dialog.yesno('[COLOR=FF67cc33]mafiatv[/COLOR]', 'Please set your HQZone credentials','or register if you dont have an account','at www.HQZone.Tv','Cancel','Login')
    if ret == 1:
