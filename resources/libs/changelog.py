...
def showChangeLog(env):
    text = ''
    if env.lower() == 'dev':
        url = 'https://github.com/mash2k3/mafiatv/commits/master'
        env = 'Dev'
        ...
        if selfAddon.getSetting("autosource") == "false":
            if selfAddon.getSetting("updateoption") == "gitupdate1":
                url = 'https://github.com/mafiatvdater/gitupdate1/commits/master'
            elif selfAddon.getSetting("updateoption") == "gitupdate2":
                url = 'https://github.com/mafiatvdater/gitupdate2/commits/master'
            else:
