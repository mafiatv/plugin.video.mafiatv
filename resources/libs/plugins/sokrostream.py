...
def MAINSS():
    main.addDir('Rechercher un film','extra',329,art+'/search.png')
    main.addDir('Nouveautes','http://sokrostream.com/',325,art+'/new.png')
    main.addDir('Les plus vues','http://sokrostream.com/les-films-les-plus-vues',325,art+'/view.png')
...
def GENRESS(murl):
    ...
    for url,genre,count in match:
        main.addDir(genre+' '+count,url,325,art+'/genre.png')
